// ── DATA (dari car_clean.csv, dihitung saat preprocessing) ──────────────
const raw = [
  { brand: "Toyota",  count: 352 },
  { brand: "Hyundai", count: 337 },
  { brand: "Tesla",   count: 330 },
  { brand: "Honda",   count: 329 },
  { brand: "Ford",    count: 326 },
  { brand: "BMW",     count: 326 },
];
...
const bars = g.selectAll(".bar")
  ...
  .join("rect")
    ...
    .attr("height", 0)               // animasi naik
    .attr("rx", 5)
    .attr("fill", d => COLOR_HEX[d.brand]);

// animasi masuk — stagger per batang
bars.transition()
  .duration(600)
  .delay((_, i) => i * 80)
...
bars
  .on("mousemove", function(event, d) {
    const rank = raw.slice().sort((a,b) => b.count - a.count)
                    .findIndex(x => x.brand === d.brand) + 1;
